...
class TickerTape {
    ...
    // get cat_html_object() {
    //     return this.cat_html_obj;
    // }
    // set cat_html_object(new_cat_html_obj) {
    //     // validation could be checked here such as only allowing objects, no nulls, etc.
    //     this.cat_html_obj = new_cat_html_obj;
    // }
    // get feed_html_object() {
    //     return this.feed_html_obj;
    // }
    // set feed_html_object(new_feed_html_obj) {
    //     // validation could be checked here such as only allowing objects, no nulls, etc.
    //     this.feed_html_obj = new_feed_html_obj;
    // }
                ...
                if (match_count > 0) {
                    ...
                    Object.keys(feed_to_parse[item].matches).forEach(function (item2) {
                        ...
                        // TODO refactor this to a function
                            ...
                            switch(feed_to_parse[item].name) {
                                case 'MLB':
                                    feedInnerHtml += '<img class="logo-image" src="' + CAT_LOGO['MLB'] + '" />';
                                    break;
                                case 'NFL':
                                    feedInnerHtml += '<img class="logo-image" src="' + CAT_LOGO['MLB'] + '" />';
                                    break;
                        ...
                        // END TODO
                            ...
                            feedInnerHtml +=feed_to_parse[item].matches[item2].away_abbreviation + '</div>';
                            //
